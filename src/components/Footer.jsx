...
export default function Footer({ language }) {
    ...
    return (
        <div className='flex flex-col justify-center items-center h-24 mt-10 bg-black text-white'>
            ...
            <p className="flex flex-row justify-center items-center gap-2">{language == "french" ? "Avec" : "With"} <GrReactjs className='text-2xl text-blue-300 font-extrabold' /> + <DiCss3 className='text-2xl text-blue-400' /> + <SiTailwindcss className='text-2xl text-blue-300' /></p>
