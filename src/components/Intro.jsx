        ...
        <div ref={ref} className="text-center py-10 px-6 pt-0">
            ...
            <div className="text-4xl flex flex-row flex-wrap justify-center">
                <ul className="flex items-center gap-6 mb-8">
                    <li className="">
                        <a target="_blank" rel="noreferrer" href="https://twitter.com/MehdiNip" className=" text-gray-500 hover:text-cyan-500" title="Twitter"><AiFillTwitterCircle /></a>
                    </li>
                    <li className="">
                        <a target="_blank" rel="noreferrer" href="https://www.linkedin.com/in/mahdi-nadir-36b39210a/" className=" text-gray-500 hover:text-cyan-900" title="LinkedIn"><AiFillLinkedin /></a>
                    </li>
                    <li className="">
                        <a target="_blank" rel="noreferrer" href="https://github.com/mahdi-nadir" className=" text-gray-500 hover:text-black" title="Github"><AiFillGithub /></a>
                    </li>
                </ul>
            </div>
        </div>
