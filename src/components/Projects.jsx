        ...
        <div ref={ref}>
            ...
            <div className='boxProject flex flex-col justify-center items-center md:flex-row md:flex-wrap gap-12 '>
                ...
                <ProjectCard
                    ...
                    soon={true}
                    description={language === "french" ? "Blackjack, comme son nom l'indique, est une application du jeu célèbre blackjack avec 2-4 joueurs. Avec un lecteur de musique intégré avec des mix bien rythmés, une explication détaillée des règles du jeu, une Interface Utilisateur (UI) attrayant et affichage responsive, Blackjack offre une expérience exceptionnelle en terme de divertissement. Jouez dès maintenant, appréciez le défi et plongez dans l'excitation du jeu où que vous soyez." : "Blackjack is an application of the famous blackjack game with 2-4 players. With a built-in music player featuring well-paced mixes, a detailed explanation of the game rules, an attractive User Interface (UI), and responsive display, Blackjack offers an exceptional entertainment experience. Play now, enjoy the challenge, and immerse yourself in the excitement of the game wherever you are."}
