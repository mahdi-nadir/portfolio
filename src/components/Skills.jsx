    ...
    return (
        <div ref={ref}>
            ...
            <div className="flex flex-col justify-center items-center gap-12 md:flex-row md:flex-wrap mb-20">
                <SkillCard source={HTML} alter="HTML" title="HTML5" mainTitle="HTML" /* percentage={95} box="boxHTML" percent="percentHTML" */ />
                <SkillCard source={CSS} alter="CSS3" title="CSS3" mainTitle="CSS" /* percentage={85} box="boxCSS" percent="percentCSS" */ />
                <SkillCard source={tailwind} alter="Tailwind" title="Tailwind" /* mainTitle="Tailwind" percentage={80} box="boxTailwind" percent="percentTailwind" */ />
                <SkillCard source={JavaScript} alter="JavaScript" title="JavaScript" mainTitle="JavaScript" /* percentage={85} box="boxJS" percent="percentJS" */ />
                <SkillCard source={react} alter="React" title="React" mainTitle="React" /* percentage={80} box="boxReact" percent="percentReact" */ />
                <SkillCard source={nextjs} alter="Next.js" title="Next.js" mainTitle="Next.js" /* percentage={80} box="boxNext" percent="percentNext" */ />
                <SkillCard source={PHP} alter="PHP" title="PHP" mainTitle="PHP" /* percentage={80} box="boxPHP" percent="percentPHP" */ />
                <SkillCard source={laravel} alter="Laravel" title="Laravel" mainTitle="Laravel" /* percentage={85} box="boxLaravel" percent="percentLaravel" */ />
                <SkillCard source={mysql} alter="MySQL" title="MySQL" mainTitle="MySQL" /* percentage={90} box="boxMySQL" percent="percentMySQL" */ />
                <SkillCard source={mongodb} alter="MongoDB" title="MongoDB" mainTitle="MongoDB" /* percentage={60} box="boxMongoDB" percent="percentMongoDB" */ />
                <SkillCard source={git} alter="Git" title="Git" mainTitle="Git" /* percentage={75} box="boxGit" percent="percentGit" */ />
